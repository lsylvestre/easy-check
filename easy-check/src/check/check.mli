...
val expr1 :
  ((('a -> 'b) as 'expr) * 'expr * Parsetree.expression) -> 
  'expr Ty.ty ->
  ?equal:('b -> 'b -> bool) ->
  ?exn_equal:(exn -> exn -> bool) ->
  ?stdout_equal:(string -> string -> bool) ->
...
val expr2 :
  ((('a -> 'b -> 'c) as 'expr) * 'expr * Parsetree.expression) -> 
  'expr Ty.ty ->
  ?equal:('c -> 'c -> bool) ->
  ?exn_equal:(exn -> exn -> bool) ->
  ?stdout_equal:(string -> string -> bool) ->
...
val expr3 :
  ((('a -> 'b -> 'c -> 'd) as 'expr) * 'expr * Parsetree.expression) -> 
  'expr Ty.ty ->  
  ?equal:('d -> 'd -> bool) ->
  ?exn_equal:(exn -> exn -> bool) ->
  ?stdout_equal:(string -> string -> bool) ->
...
val expr4 :
  ((('a -> 'b -> 'c -> 'd -> 'e) as 'expr) * 'expr * Parsetree.expression) ->
  'expr Ty.ty ->
  ?equal:('e -> 'e -> bool) ->
  ?exn_equal:(exn -> exn -> bool) ->
  ?stdout_equal:(string -> string -> bool) ->
...
val expr5 : 
  ((('a -> 'b -> 'c -> 'd -> 'e -> 'f) as 'expr) * 'expr * Parsetree.expression) ->
  'expr Ty.ty ->
  ?equal:('f -> 'f -> bool) ->
  ?exn_equal:(exn -> exn -> bool) ->
  ?stdout_equal:(string -> string -> bool) ->
...
val expr : 'a * 'a * Parsetree.expression -> 'a Ty.ty -> ?equal:('a -> 'a -> bool) -> unit -> Report.t

val name_correct : string -> Report.t
val expr_correct : ('a * 'b * Parsetree.expression) -> Report.t